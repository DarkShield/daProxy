...
var handle_request = function(that, request, response, type) {
  ...
  if(processor) processor.emit('request', request, processor_object);
  ...
  var proxy_request = (req_url.protocol == "https:" ? https : http).request(request_options, function(proxy_response) {
    ...
    if (that.options.hosts[request_options.host.replace(/\./g, "")] === 'enabled') {
    //if (request_options.host == 'blog.risk.io' || request_options.host == 'www.edbellis.com' || request_options.host == 'edbellis.com' || request_options.host == 'dashboard.darkshield.io' || request_options.host == 'darkshield.io' || request_options.host == 'www.darkshield.io' || request_options.host == 'www.mattjay.com' || request_options.host == 'mattjay.com' || request_options.host == 'dashboard.vicetek.com'){
      console.log('On Domain');
    }
    else {//if (that.options.hosts[request_options.host.replace(/\./g, "")] === 'disabled' || request_options.host === 'localhost' || request_options.host === '184.73.162.139' ){
