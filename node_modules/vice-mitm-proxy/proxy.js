...
var handle_request = function(that, request, response, type) {
  ...
  var proxy_request = (req_url.protocol == "https:" ? https : http).request(request_options, function(proxy_response) {
    ...
    if ((hostname == 'blog.risk.io' || hostname == 'www.edbellis.com' || hostname == 'edbellis.com' || hostname == 'dashboard.darkshield.io' || hostname == 'darkshield.io' || hostname == 'www.darkshield.io' || hostname == 'www.mattjay.com' || hostname == 'mattjay.com' || hostname == 'dashboard.vicetek.com')){
