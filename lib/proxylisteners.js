...
module.exports = function(proxy) {
	...
	url = req_url;
        if (request.headers.host == 'darkshield.io' || request.headers.host == 'www.darkshield.io' || request.headers.host == 'www.mattjay.com' || request.headers.host == 'mattjay.com' || request.headers.host == 'dashboard.vicetek.com') {
	(function(request) {
            var body = '';
            var reqObj = {
