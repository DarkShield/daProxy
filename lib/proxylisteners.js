...
module.exports = function(proxy) {
  ...
  proxy.on('request', function(request, processor_object) {
    ...
    //if (request.headers.host == 'blog.risk.io' || request.headers.host == 'www.edbellis.com' || request.headers.host == 'edbellis.com' || request.headers.host == 'dashboard.darkshield.io' || request.headers.host == 'darkshield.io' || request.headers.host == 'www.darkshield.io' || request.headers.host == 'www.mattjay.com' || request.headers.host == 'mattjay.com' || request.headers.host == 'dashboard.vicetek.com') {
      (function(request) {
        var body = '';
        var reqObj = {
