...
var handleRequest = function (request, response) {
  ...
  if (request.headers.host && Allowed_hosts[request.headers.host.replace(/\./g, "")] && Allowed_hosts[request.headers.host.replace(/\./g, "")].status === 'enabled' && checkBlacklist(request) == false) {
